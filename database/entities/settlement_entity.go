...
type Settlement struct {
	MerchantID string    `gorm:"type:text;not null;index:idx_settlement_unique,priority:1" db:"merchant_id" json:"merchant_id"`
	Date       time.Time `gorm:"type:date;not null;index:idx_settlement_unique,priority:2" db:"date" json:"date"`
